...
public class UI {
   ...
   public void draw(Graphics2D g2) {
      ...
      // winState
         ...
         drawSideBar(Consts.SCREEN_WIDTH, 0, Consts.SCREEN_HEIGHT, gp.sideBarWidth);
         drawSubWindow(1 * Consts.TILE_SIZE, 1 * Consts.TILE_SIZE, gp.getWidth() - 2 * Consts.TILE_SIZE,
               gp.getHeight() - 2 * Consts.TILE_SIZE);
   ...
   public void drawSideBar(int x, int y, int height, int width) {
      ...
      try {
         coin = ImageIO.read(getClass().getResourceAsStream("/sprites/Objects/DroppedItem/coins.png"));
      } catch (Exception e) {
      }
      ...
      try {
         // Sword=
         // ImageIO.read(getClass().getResourceAsStream("/sprites/Objects/MenuItems/sword.png"));
      } catch (Exception e) {
      }
      ...
      try {
         Bomb = ImageIO.read(getClass().getResourceAsStream("/sprites/Objects/DroppedItem/bomb.png"));
      } catch (Exception e) {
      }
