...
public class Event {
   ...
   public Event(int x, int y, int sizeX, int sizeY) {
      ...
      solidArea = new Rectangle(screenX - (sizeX / 2) * Consts.TILE_SIZE + shrink,
            screenY - (sizeY / 2) * Consts.TILE_SIZE + shrink, (Consts.TILE_SIZE * sizeX) - 2 * shrink,
            (Consts.TILE_SIZE * sizeY) - 2 * shrink);
   }
   ...
   public Event(int x, int y) {
      ...
      solidArea = new Rectangle(screenX + shrink, screenY + shrink, Consts.TILE_SIZE - 2 * shrink,
            Consts.TILE_SIZE - 2 * shrink);
   }
